This is a space simulator which is to be run in Blender (version 2.76b at the time of this writing). Currently, it is a naive N-body simulator, which will be expanded in the near future as follows:
